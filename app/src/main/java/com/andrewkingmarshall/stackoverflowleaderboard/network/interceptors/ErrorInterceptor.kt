package com.andrewkingmarshall.stackoverflowleaderboard.network.interceptors
 ...
 *
 */
class ErrorInterceptor @Inject constructor(@ApplicationContext private val context: Context) :
    Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val response: Response = try {
            ...
            val noNetworkDetectedException =
                UnknownHostException(context.getString(R.string.no_network_detected))
...
class NetworkException(val errorMessage: String, val httpErrorCode: Int = -1) :
